...
bminor: bminor.o parser/parse.o encoder/encode.o scanner/scan.o resolver/resolve.o typechecker/typecheck.o codegenerator/codegen.o decl.o expr.o param_list.o type.o symbol.o stmt.o hash_table.o scope.o
	$(GCC) $(CFLAGS) -o $@ $^
...
typechecker/typecheck.o: typechecker/typecheck.c typechecker/typecheck.h
	$(CC) $(CFLAGS) -c -o $@ $<

codegenerator/codegen.o: codegenerator/codegen.c codegenerator/codegen.h
	$(CC) $(CFLAGS) -c -o $@ $<
...
clean:
	...
	rm -f test/codegen/book_tests/*.out
	rm -f test/codegen/book_tests/*.s
	rm -f test/codegen/book_tests/*[0-9]
	rm -f bminor
